...
var engineGraphQLPolicy = graphQLAuthorizationPolicy{
	queryRoots: map[string]graphQLFieldPolicy{
		...
		"webhookEvents":              argumentPermissions(accesscontrol.ResourceService, "service_id", accesscontrol.PermissionServiceRead),
		"webhookAnalytics":           argumentPermissions(accesscontrol.ResourceService, "service_id", accesscontrol.PermissionServiceRead),
