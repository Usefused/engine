...
// Dynamic client limits apply to consented clients, since registration is anonymous.
const (
	OAuthDynamicClientMaxTTL            = time.Hour
...
type OAuthClientStore interface {
	...
	// RegisterOAuthClient persists an anonymous temporary client pair. It grants
	// no workspace access until an authenticated user consents.
