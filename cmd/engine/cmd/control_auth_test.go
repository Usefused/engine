...
func TestClassifyEngineRequest(t *testing.T) {
	tests := []struct {
		...
		{method: http.MethodPost, path: "/v1/apps/" + uuid.NewString() + "/executions", want: requestClassRuntimeExcluded},
		{method: http.MethodGet, path: "/v1/apps/" + uuid.NewString() + "/executions", want: requestClassUnclassified},
		{method: http.MethodPost, path: "/v1/apps/" + uuid.NewString() + "/executions/", want: requestClassUnclassified},
		{method: http.MethodPost, path: "/v1/apps/" + uuid.NewString() + "/executions/extra", want: requestClassUnclassified},
		{method: http.MethodPost, path: "/v1/apps/" + uuid.NewString() + "/tokens", want: requestClassUnclassified},
